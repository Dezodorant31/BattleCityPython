    ...
    def draw(self):
        ...
        for obj in objects:
            if obj.type == 'tank':
                ...
                text = fontUI.render(str(obj.rank), True, 'black')
...
class Tank:
    ...
    def update(self):
        ...
        if self.rect.x < 0 or self.rect.x > WIDTH-25 or self.rect.y < 0 or self.rect.y > HEIGHT-25:
...
Tank('red', 1100, 275, 0, (pygame.K_LEFT, pygame.K_RIGHT, pygame.K_UP, pygame.K_DOWN, pygame.K_KP_ENTER))
ui = UI()
